				...
				<div class="panel panel-default">
					...
					<div class="panel panel-body">
						...
						<div style="position: relative; max-height: 510px; overflow-y: scroll;">
							<table class="table table-hover fixed-table-container" id="tableLSP">
								<thead style="position: sticky; top: 0px;">
									<th style="padding-left: 5px">ID</th>
									<th style="padding-left: 5px">Tên loại</th>
						...
						<div style="width: 48%; display: inline-block; vertical-align: top; margin-left: 30px;">
							<fieldset class="panel panel-footer" id="formLSP" style="display: block; border: 1px solid rgba(120, 120, 120, 0.5); background-clip: padding-box;">
								<legend>Bảng chỉnh sửa</legend>
								<form action="qlloaisanpham.php" method="post" role="form" id="innerForm">
									<div class="form-group">
										<label>Tên loại</label>
										<input class="form-control" style="width: 50%" type="text" name="TenLSP" id="lbName" placeholder="Nhập loại sản phẩm"/>
										<div id="errorName" style="display: none;">Vui lòng nhập đầy đủ tên loại</div>
									</div>
									...
									<button class="btn btn-primary btnConfirm" type="submit" name="addLSP-btn" id ="addLSP-btn" value="">Thêm</button>
									<button class="btn btn-primary btnConfirm" type="submit" name="delLSP-btn" id ="delLSP-btn" value="">Xóa</button>
								</form>
							</fieldset>
						</div>
					</div>
...
<!--	<script src="js/chart-data.js"></script>-->
	...
	<script src="js/qlloaisanpham.js"></script>
	<script>
		!function ($) {
