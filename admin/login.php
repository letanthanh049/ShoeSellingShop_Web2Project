<?php
	include_once('class/checklogin.php');
?>
<!DOCTYPE html>
<html>
<head>
...
-->
							<?php
								...
								if (isset($_POST['login'])) 
									if ($user != "" && $pass != "") {
										$p = new login();
										$p -> check_login($user, $pass);
									}
									else if ($user == "" && $pass != "")
										echo "<p style='color: red;'>Vui lòng nhập tên tài khoản</p>";
									else if ($user != "" && $pass == "")
										echo "<p style='color: red;'>Vui lòng nhập mật khẩu</p>";
									else  if ($user == "" && $pass == "")
										echo "<p style='color: red;'>Vui lòng nhập tên tài khoản, mật khẩu</p>";
							?>
