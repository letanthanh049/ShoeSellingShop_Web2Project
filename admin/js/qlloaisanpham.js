		...
		function getRowData() {
			$('#tableLSP').on('click', '#btn-select', function() {
				...
				$('#delLSP-btn').attr('value', id);
			})
		}
		
			/*Tạo event cho nút thêm ở Bảng chỉnh sửa*/
			/*Check xem Field Tenloai có trống không nếu có ngăn submit và báo lỗi*/
			...
			/*Tạo event cho tất cả các nút sửa*/
